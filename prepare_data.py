...
def test_data(data_path):
    ...
    for i in range(1,4000):
        ...
        file_save  = sfile[0] + '/Tests/' + str(i) + '.csv'
...
if __name__ =='__main__':
    # workpiece_name = 'PW11'
    # img_path = '/mnt/daten/InstanceSegmentation/Raw/simulated_data/' +   workpiece_name + '/DepthMaps/DepthMap_ID'
    # labels_path = '/mnt/daten/InstanceSegmentation/Raw/simulated_data/' +   workpiece_name +'/SegmentationMasks/SegmentationMask_ID'
    # save_path_contours = '/mnt/daten/InstanceSegmentation/Raw/simulated_data/' +   workpiece_name +'/Contours/ID_'
    # save_path_csv = '/mnt/daten/InstanceSegmentation/Raw/simulated_data/' +   workpiece_name +'/DepthMapsCSV/ID_'
    # create_depth_csv_contours(img_path,labels_path,save_path_contours,save_path_csv,21)

    data_path_real = '/mnt/daten/InstanceSegmentation/Raw/real_data/*/*/*/*'
    file_name_real = 'depthmap_manual_filtered.csv'
    data_path_simulated = '/mnt/daten/InstanceSegmentation/Raw/simulated_data/*/DepthMapsCSV/'
    file_name_simulated = '.csv'
    save_path = '/mnt/daten/InstanceSegmentation/Prepared_data/Sim_Real1/'
    data_path_prepared = '/mnt/daten/InstanceSegmentation/Prepared_data/Sim_Real1/DepthMapsCSV/'
    #write_cropped_pointclouds(data_path,-500,400,200,1000,-40,250)zhnm.,
    # file_name =  write_projected_depthmaps(data_path,1, z_flip=False)
    # file_name =  calculateLabels(data_path,file_name, max_distance_euclidean=0.8, region_x1 = 40, region_x2 = 560,
    #                              region_y1 = 40,region_y2 = 380, max_z = 240, min_z=10)
    # start_manual_labelling(data_path,file_name)
    # create_data_augmentations(data_path_real, file_name_real)
    #create_real_depthmap_contours(data_path,file_name)
    #create_data(data_path_real,file_name_real,data_path_simulated,file_name_simulated,save_path)
    #create_train_test_list(save_path)
    test_data(data_path_prepared)
    ...
    #         print('Flipping ', file)
    #         depthmap, labels =  CsvReader.load(file)
    #         depthmap = depthmap_helpers.flip_depthimage(depthmap)
    #         CsvReader.save(depthmap,labels,file)
